...
<h1 className="tronText" style={{display:'grid', placeContent:'center', textAlign:'center', fontSize:'14vw', position:'absolute', top:'0', marginTop:'', width:'100%', padding:'0 30%', opacity:'1', zIndex:'0'}}>
 ...
 <ReactPlayer
       ...
       >
          ...
          <Link to="/enter-the-grid/" style={{color:'#37f8f8',  height:'100vh', width:'100vw', display:'grid', placeContent:'center', border:'0px solid yellow', position:'relative', top:'40vh'}}>
            <div className="" style={{
