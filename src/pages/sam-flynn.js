...
<div id="" className="characters" style={{position:'relative', zIndex:'0', width:'100vw', height:'100vh', top:'0', background:'none', filter:'none', boxShadow:'none', padding:'10vh 0 0 0', overflow:'hidden', border:'0px solid blue'}}>
...
alt="Todd Lambert Web development for photographers" src="../../static/assets/sam-flynn.png" />
  ...
  <div className="" style={{display:'flex', gap:'', justifyContent:'', position:'absolute', left:'10vw',  marginTop:'5vh', marginRight:''}}>

  <div>
  <h2 className="tronText" style={{paddingTop:'12vh', fontSize:'clamp(2rem, 3vw, 3rem)'}}>Sam Flynn</h2>
